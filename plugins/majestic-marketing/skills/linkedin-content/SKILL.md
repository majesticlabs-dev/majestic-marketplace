...
description: Create high-performing LinkedIn content with algorithm-optimized hooks and posting strategy. Use when building a personal brand on LinkedIn, planning LinkedIn content, or writing posts that drive engagement. Includes format templates for text posts, carousels, short videos, polls, and content pillar strategy. Covers 2026 algorithm signals (saves, DM shares), link placement, daily engagement habits, and profile optimization.
...
- Current LinkedIn algorithm priorities (2026 data)
...
See [references/templates.md](references/templates.md) for 15+ hook examples.
...
**Short Video Rules:**
- Hook in first 3 seconds (visual or spoken pattern interrupt)
- One clear insight per video, under 90 seconds
- Captions are non-negotiable — 80%+ watch without sound
- This is a scroll platform, not YouTube. 5-10 minute videos get skipped
...
- Do NOT post and disappear. This window is the difference between 2K and 30K+ impressions

### 5. Daily Engagement (Non-Negotiable)

Spend 15-20 minutes daily leaving substantive comments on posts in your niche:
- Puts your name in front of other creators' audiences (free distribution)
- Trains the algorithm to associate your profile with activity and relevance
- Builds relationships that compound into collaborations and referrals
...
- **Research current algorithm**: Verify 2026 practices via WebSearch
- **Platform-specific**: Professional context matters (not Instagram/X)
- **Mobile-first**: 60%+ consumed on mobile
- **Save-focused**: Saves and DM shares > comments > likes
- **Authentic voice**: No LinkedIn-speak, no AI-generated McKinsey-tone
- **Personal profile**: Always default to personal profile strategy, not company page
