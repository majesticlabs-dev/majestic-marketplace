...
### Step 2: Add to skill-rules.yaml
...
- [ ] Entry added to `skill-rules.yaml`
...
- [ ] YAML syntax validated: `yq . skill-rules.yaml`
...
### [trigger-types.md](references/trigger-types.md)
...
2. Add entry to `.claude/skills/skill-rules.yaml`
...
See [trigger-types.md](references/trigger-types.md) for complete details.
...
See [troubleshooting.md](references/troubleshooting.md) for complete debugging guide.

## Related Files

**Configuration:**
- `.claude/skills/skill-rules.yaml` - Master configuration
