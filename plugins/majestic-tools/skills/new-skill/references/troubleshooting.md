...
**Check:**
- Look at `promptTriggers.keywords` in skill-rules.yaml
...
**Fix:** Add more keyword variations to skill-rules.yaml
...
- Skill name in skill-rules.yaml
- Must match exactly
...
- `fileTriggers.pathPatterns` in skill-rules.yaml
- Glob pattern syntax
...
**Check:**
- Count patterns in skill-rules.yaml
