# skill-rules.yaml - Complete Reference

Complete schema and configuration reference for `.claude/skills/skill-rules.yaml`.
...
**Path:** `.claude/skills/skill-rules.yaml`

This YAML file defines all skills and their trigger conditions for the auto-activation system.
...
```bash
yq .claude/skills/skill-rules.yaml
```
