...
- `relay.quality_gate_agent majestic-engineer:workflow:quality-gate` - get relay agent path
...
| `relay.quality_gate_agent` | Quality gate agent for relay | `majestic-engineer:workflow:quality-gate` |
| `relay.lessons_agent` | Lessons agent for relay | `majestic-engineer:workflow:lessons-discoverer` |
| `relay.skip_lessons` | Skip lessons discovery in relay | `false` |
