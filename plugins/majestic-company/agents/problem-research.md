...
This agent analyzes reviews from G2, Capterra, TrustRadius, Reddit, and other platforms to extract:
...
```
PPS = Frequency Score x Severity Score x Recency Multiplier
```
...
```
Hidden Gem Score = Pain Frequency x Competitor Gap Score
```
