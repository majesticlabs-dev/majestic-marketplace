...
**Goal:** Perform evidence-backed 360 degree audit with 0-10 scoring across 6 dimensions, benchmark against competitors, prioritize bottlenecks by impact x ease, and deliver a week-by-week 90-day roadmap.
...
- **Number of Customers:** Current count
...
**Evidence Rule:** Cite at least 2 independent sources for every non-obvious claim.
...
3. **Surface bottlenecks** ranked by impact x ease
4. **Prescribe** quick wins (90 days or less) + strategic plays (>90 days)
...
**Top Bottlenecks** (ranked by impact x ease)
| Bottleneck | Impact (1-10) | Ease (1-10) | Score | Why |
|------------|---------------|-------------|-------|-----|
| ... | ... | ... | ... | ... |

### Quick Wins (90 days or less)
