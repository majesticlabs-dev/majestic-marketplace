...
Please provide:
1. **Your product/service** (what you're building)
2. **Target market** (who you serve)
3. **Key competitive advantage** (what makes you different)
4. **Your personal connection** to this problem
5. **Current round details** (amount, terms, how much committed)
6. **Any unique timing factors** (market shifts, regulations, technology changes)"
...
| Section | Duration | Energy Level | Eye Contact |
|---------|----------|--------------|-------------|
| Market insight | 10 sec | Medium-high | Scan room |
| Proprietary advantage | 10 sec | High | Key decision maker |
| Founder mission | 12 sec | Lower, authentic | Break eye contact briefly |
| FOMO + ask | 13 sec | Confident, steady | Direct to lead |
...
1. "Want me to help you practice responses to likely objections?"
2. "Should I create a longer 90-second version with more depth?"
3. "Need help with the transition INTO this close from your main pitch?"
