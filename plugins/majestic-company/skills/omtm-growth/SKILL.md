...
**When You Miss 7%:**
1. Don't panic - single weeks vary
...
1. **Check for OMTM:** Do they have ONE metric? If multiple, help narrow.
2. **Check the math:** Is their target realistic? Use 7% as benchmark.
3. **Check accountability:** Who knows their numbers? Suggest public sharing.
...
- Use with `growth-audit` for comprehensive assessment
- Use with `first-principles` to identify true OMTM
