...
Generic orchestrators (`/majestic-engineer:blueprint`, `/majestic:build-task`, `quality-gate`) invoke this agent to get stack-specific capabilities without hardcoding stack logic.
