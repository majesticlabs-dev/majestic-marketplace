...
File created:
- .agent-os/lessons/[category]/[filename].md
...
3. Append to .agent-os/lessons/patterns/critical-patterns.md
...
**Source:** `.agent-os/lessons/[category]/[filename].md`
```
...
2. Search .agent-os/lessons/ for matching doc
