...
Examples:
    ...
    python edit_image.py portrait.jpg "Make it look like a Van Gogh painting" artistic.jpg
...
def main():
    ...
    parser.add_argument("output", help="Output file path (use .jpg extension)")
    parser.add_argument(
        "--model",
        "-m",
